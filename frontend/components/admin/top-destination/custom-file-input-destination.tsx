...
import { toast } from 'react-hot-toast'; // gunakan react-hot-toast agar lebih bagus

const MAX_FILE_SIZE_MB = 10;

const CustomFileInputDestination = ({
  accept,
  supportFile,
  field,
}: {
  ...
  const onChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file && validateFileSize(file)) {
      ...
      // jika file besar, hapus file input
      e.target.value = '';
    }
  };
...
export default CustomFileInputDestination;
