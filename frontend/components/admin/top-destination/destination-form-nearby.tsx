...
import CustomFileInputNearbyDestination from "./custom-file-input-nearby-destination";
...
export default function DestinationFormNearby({
  onSubmit,
  defaultValues,
}: {
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-md w-full">
      <h1 className="text-2xl font-bold mb-6 text-black">
        Tambah Data Destination Nearby
      </h1>
      ...
      >
        ...
        <div>
          ...
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <CustomFileInputNearbyDestination field={field} accept="image/*" supportFile="PNG, JPG, WEBP" />
            )}
          />
        </div>
        ...
        <div className="flex gap-3 mt-4">
          <Button type="submit" className="flex-1 bg-blue-600 text-white hover:bg-blue-700">Simpan</Button>
